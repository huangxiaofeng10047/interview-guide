...
class KnowledgeBaseVectorServiceTest {
    ...
    class SimilaritySearchTests {
        ...
        void testBasicSearchWithoutFilter() {
            ...
            // When
            List<Document> results = vectorService.similaritySearch(query, null, topK,0);
        ...
        void testTopKLimit() {
            ...
            // When
            List<Document> results = vectorService.similaritySearch(query, List.of(1L), topK,0);
        ...
        void testSearchFailureThrowsException() {
            ...
            RuntimeException exception = assertThrows(
                RuntimeException.class,
                () -> vectorService.similaritySearch(query, null, 5,0)
            );
        ...
        void testSearchWithEmptyKnowledgeBaseIdList() {
            ...
            // When
            List<Document> results = vectorService.similaritySearch(query, emptyList, topK,0);
        ...
        void testSearchReturnsEmpty() {
            ...
            // When
            List<Document> results = vectorService.similaritySearch(query, null, 10,0);
        ...
        void testFilteredResultsEmpty() {
            ...
            // When
            List<Document> results = vectorService.similaritySearch(query, knowledgeBaseIds, 10,0);
    ...
    class EdgeCaseTests {
        ...
        void testEmptyQuery() {
            ...
            // When
            List<Document> results = vectorService.similaritySearch(emptyQuery, null, 5,0);
        ...
        void testTopKZero() {
            ...
            // When
            List<Document> results = vectorService.similaritySearch(query, null, 0,0);
